    ...
    steps: [
      {
        ...
        description: 'Command Center synthesizes signals across all household domains to tell you what happened, why it matters, and what to do next.',
        placement: 'center',
      },
      {
        ...
        description: 'A 0-100 composite score evaluating your documentation completeness, maintenance compliance, financial safety, and risk exposure.',
        placement: 'bottom',
      },
      {
        targetSelector: '#command-center-needs-attention',
        tab: 'dashboard',
        title: 'Needs Attention Triage',
        description: 'High-priority alerts for approaching warranty expirations, overdue maintenance, unaddressed issues, and upcoming utility bills.',
        placement: 'top',
      },
      {
        ...
        description: 'Synthesized, deduplicated recommendations with direct deep links to open modals, snooze, or mark items complete.',
        placement: 'top',
      },
      {
        ...
        description: 'Timeline of upcoming maintenance visits, loan payments, bill due dates, and warranty milestones across the next 30 days.',
        placement: 'top',
      },
    ],
  },
